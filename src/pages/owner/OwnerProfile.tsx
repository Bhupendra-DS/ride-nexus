...
import { LayoutDashboard, Car, Calendar, DollarSign, User as UserIcon } from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Profile', href: '/owner/profile', icon: <UserIcon size={16} /> },
];
...
export default function OwnerProfile() {
  ...
  return (
    <DashboardLayout navItems={navItems} title="Owner Profile">
      <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="space-y-8 pb-20 md:pb-0">
        <motion.div variants={fadeInUp}>
          <h1 className="font-display text-2xl font-bold">My Profile</h1>
          <p className="text-muted-foreground mt-1">Manage your owner account details.</p>
        </motion.div>
